...
class BinanceInverseGateway(BaseGateway):
    """vn.py trading interface for the reinforcement contract """
    ...
    def connect(self, setting: dict) -> None:
        ...
        proxy_host: int = setting[" agent address "]
...
class BinanceInverseRestApi(RestClient):
    """ coin security contract REST API"""
    ...
    def query_history(self, req: HistoryRequest) -> List[BarData]:
        ...
        while True:
            ...
            if req.start:
                ...
                params["startTime"] = start_time * 1000     #  convert into milliseconds 
...
class BinanceInverseTradeWebsocketApi(WebsocketClient):
    """ trading of currency against contract Websocket API"""
...
class BinanceInverseDataWebsocketApi(WebsocketClient):
    """ currency anti-to-contract Websocket API"""
